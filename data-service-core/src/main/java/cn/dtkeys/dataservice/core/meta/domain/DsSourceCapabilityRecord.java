...
public class DsSourceCapabilityRecord {
    ...
    public String getCapabilityDetailJson() { return capabilityDetailJson; }
    public void setCapabilityDetailJson(String capabilityDetailJson) { this.capabilityDetailJson = capabilityDetailJson; }
