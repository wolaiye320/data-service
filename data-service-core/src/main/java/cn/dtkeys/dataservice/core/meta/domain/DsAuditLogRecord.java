...
public class DsAuditLogRecord {
    ...
    public String getContextSummaryJson() { return contextSummaryJson; }
    public void setContextSummaryJson(String contextSummaryJson) { this.contextSummaryJson = contextSummaryJson; }
