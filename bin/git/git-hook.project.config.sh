...
GIT_HOOK_BACKEND_MODULES="${GIT_HOOK_BACKEND_MODULES:-data-service-core data-service-app}"
GIT_HOOK_BACKEND_MODULE_PATTERNS="${GIT_HOOK_BACKEND_MODULE_PATTERNS:-data-service-core/* data-service-app/*}"
